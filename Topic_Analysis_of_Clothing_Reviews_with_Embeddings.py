# Project Description : 
# In the competitive world of e-commerce, understanding customer feedback is vital for business success. This project focuses on analyzing reviews from the Women's Clothing E-Commerce Reviews dataset. 
# The challenge is to process and analyze text data, categorize feedback into themes, and perform semantic and similarity searches to gain deeper understanding of customer sentiments.
